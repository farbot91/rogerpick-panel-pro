...
![بنر Rogerpick Panel Pro](project/static/web/dashboard_banner.png)
...
نمونه تصویر شروع ربات:

![بنر شروع ربات](project/static/telegram/start_banner.jpg)
...
نمونه تصویر بنر و هویت بصری پنل:

![بنر داشبورد پنل](project/static/web/dashboard_banner.png)
